<?php include "header.php" ?>
    <section class="empresa-box">
        <div class="container">

            <div class="empresa">
                <h1 class="texto-historia">Um pouco da nossa história</h1>
                <p class="texto">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                    has been the
                ...
                <p class="texto"> "On the other hand, we denounce with righteous indignation and dislike men who are so
